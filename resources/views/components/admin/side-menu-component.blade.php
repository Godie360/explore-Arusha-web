    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="{{ route('admin.dashboard.index') }}" class="active"><i class="fe fe-grid"></i> <span>Dashboard</span></a>
                </li>
                <li class="menu-title">
                    <h6>Listing</h6>
                </li>
                <li>
                    <a href="listings.html"><i class="fe fe-briefcase"></i>
                        <span>Listings</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="sub-categories.html"><i class="fe fe-clipboard"></i>
                        <span>Sub Categories</span></a>
                </li>
                <li>
                    <a href="locations.html"><i class="fe fe-map"></i><span>Locations</span></a>
                </li>
                <li class="submenu">
                ...
                <li>
                    <a href="comments.html"><i class="fe fe-message-square"></i><span>Comments</span></a>
                </li>
                <li>
                    <a href="amenities.html"><i class="fe fe-briefcase"></i><span>Amenities</span></a>
                </li>
                <li>
                    <a href="product-enquiry.html"><i class="fe fe-box"></i><span>Product Enquiry</span></a>
                </li>
                <li class="menu-title">
                    <h6>Finance & Accounts</h6>
                </li>
                <li>
                    <a href="transactions.html"><i class="fe fe-bar-chart"></i> <span>Transactions</span></a>
                </li>
                <li>
                    <a href="payment-gateway.html"><i class="fe fe-file-text"></i>
                ...
                <li>
                    <a href="membership-transactions.html"><i class="fe fe-user-plus"></i>
                ...
                <li>
                    <a href="membership-transactions.html"><i class="fe fe-tv"></i>
                ...
                <li>
                    <a href="roles-permissions.html"><i class="fe fe-file-text"></i>
                        <span>Roles & Permissions</span></a>
                </li>
                <li>
                    <a href="delete-account-requests.html"><i class="fe fe-trash-2"></i>
                ...
                <li>
                    <a href="contact-messages.html"><i class="fe fe-message-square"></i>
