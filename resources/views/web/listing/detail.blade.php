             ...
             <div class="bannergallery-section">
                 <div class="gallery-slider d-flex">
                     <div class="gallery-widget">
                         <a href="assets/img/gallery/gallery1/gallery-1.jpg" data-fancybox="gallery1">
                             <img class="img-fluid" alt="Image" src="assets/img/gallery/gallery1/gallery-1.jpg">
                         </a>
                     </div>
                     <div class="gallery-widget">
                         <a href="assets/img/gallery/gallery1/gallery-2.jpg" data-fancybox="gallery1">
                             <img class="img-fluid" alt="Image" src="assets/img/gallery/gallery1/gallery-2.jpg">
                         </a>
                     </div>
                     <div class="gallery-widget">
                         <a href="assets/img/gallery/gallery1/gallery-3.jpg" data-fancybox="gallery1">
                             <img class="img-fluid" alt="Image" src="assets/img/gallery/gallery1/gallery-3.jpg">
                         </a>
                     </div>
                     <div class="gallery-widget">
                         <a href="assets/img/gallery/gallery1/gallery-4.jpg" data-fancybox="gallery1">
                             <img class="img-fluid" alt="Image" src="assets/img/gallery/gallery1/gallery-4.jpg">
                         </a>
                     </div>
                     <div class="showphotos">
                         <a href="assets/img/gallery/gallery1/gallery-3.jpg" data-fancybox="gallery1">... Show
                             Photos</a>
                     </div>
                 </div>
             </div>
                         ...
                         <div class="row">
                             <div class="col-lg-9">
                                 <ul>
                                     ...
                                     <li><a href="javascript:void(0);"><img src="assets/img/website.svg"
                                                 alt="website">Website</a></li>
                                 ...
                                 <div class="card-body">
                                     <div class="lisiting-featues">
                                         <div class="row">
                                             ...
                                             <div class="featureslist d-flex align-items-center col-lg-4 col-md-4">
                                                 <div class="feature-img">
                                                     <img src="assets/img/featured/Feature-2.svg"
                                             ...
                                             <div class="featureslist d-flex align-items-center col-lg-4 col-md-4">
                                                 <div class="feature-img">
                                                     <img src="assets/img/featured/Feature-3.svg"
                                             ...
                                             <div class="featureslist d-flex align-items-center col-lg-4 col-md-4">
                                                 <div class="feature-img">
                                                     <img src="assets/img/featured/Feature-5.svg"
                                                         alt="Media Technology">
                                                 </div>
                                                 <div class="featues-info">
                                             ...
                                             <div class="featureslist d-flex align-items-center col-lg-4 col-md-4">
                                                 <div class="feature-img">
                                                     <img src="assets/img/featured/Feature-6.svg"
                                                         alt="Media Technology">
                                                 </div>
                                                 <div class="featues-info">
                                             ...
                                             <div
                                                 ...
                                                 <div class="feature-img">
                                                     <img src="assets/img/featured/Feature-7.svg"
                                                         alt="Media Technology">
                                                 </div>
                                                 <div class="featues-info">
                                             ...
                                             <div
                                                 ...
                                                 <div class="feature-img">
                                                     <img src="assets/img/featured/Feature-8.svg"
                                                         alt="Media Technology">
                                                 </div>
                                                 <div class="featues-info">
                                     ...
                                     <div class="gallery-content">
                                         <div class="row">
                                             <div class="col-lg-3 col-md-3 col-sm-3">
                                                 <div class="gallery-widget">
                                                     <a href="assets/img/gallery/gallery1/gallery-5.jpg"
                                                         data-fancybox="gallery1">
                                                         <img class="img-fluid" alt="Image"
                                                             src="assets/img/gallery/galleryimg-1.jpg">
                                                     </a>
                                                 </div>
                                             </div>
                                             <div class="col-lg-3 col-md-3 col-sm-3">
                                                 <div class="gallery-widget">
                                                     <a href="assets/img/gallery/gallery1/gallery-6.jpg"
                                                         data-fancybox="gallery1">
                                                         <img class="img-fluid" alt="Image"
                                                             src="assets/img/gallery/galleryimg-2.jpg">
                                                     </a>
                                                 </div>
                                             </div>
                                             <div class="col-lg-3 col-md-3 col-sm-3">
                                                 <div class="gallery-widget">
                                                     <a href="assets/img/gallery/gallery1/gallery-8.jpg"
                                                         data-fancybox="gallery1">
                                                         <img class="img-fluid" alt="Image"
                                                             src="assets/img/gallery/galleryimg-3.jpg">
                                                     </a>
                                                 </div>
                                             </div>
                                             <div class="col-lg-3 col-md-3 col-sm-3">
                                                 <div class="gallery-widget me-0">
                                                     <a href="assets/img/gallery/gallery1/gallery-11.jpg"
                                                         data-fancybox="gallery1">
                                                         <img class="img-fluid" alt="Image"
                                                             src="assets/img/gallery/galleryimg-11.jpg">
                                                     </a>
                                                 </div>
                                             </div>
                                             <div class="col-lg-3 col-md-3 col-sm-3">
                                                 <div class="gallery-widget">
                                                     <a href="assets/img/gallery/gallery1/gallery-9.jpg"
                                                         data-fancybox="gallery1">
                                                         <img class="img-fluid" alt="Image"
                                                             src="assets/img/gallery/galleryimg-9.jpg">
                                                     </a>
                                                 </div>
                                             </div>
                                             <div class="col-lg-3 col-md-3 col-sm-3">
                                                 <div class="gallery-widget">
                                                     <a href="assets/img/gallery/gallery1/gallery-10.jpg"
                                                         data-fancybox="gallery1">
                                                         <img class="img-fluid" alt="Image"
                                                             src="assets/img/gallery/galleryimg-10.jpg">
                                                     </a>
                                                 </div>
                                             </div>
                                             <div class="col-lg-3 col-md-3 col-sm-3">
                                             ...
                                             <li class="review-box ">
                                                 ...
                                                 <div class="review-details">
                                                     ...
                                                     <div class="rating">
                                                         ...
                                                         <div><i class="fa-sharp fa-solid fa-calendar-days"></i> 4
                                                             months ago</div>
                             ...
                             <div class="rightsidebar">
                                 ...
                                 <div class="card">
                                     ...
                                     <div class="map-details">
                                         ...
                                         <ul class="info-list">
                                             <li><i class="feather-map-pin"></i> 484, Ellis st, San Fransisco,<br>CS
                                                 94102, United States</li>
                                             ...
                                             <li><i class="feather-mail"></i> <a
                                                     ...
                                                     class="__cf_email__"
                                                     data-cfemail="23505653534c5157634f4a505746460d404c4e">[email&#160;protected]</a>
                                             </li>
                                     ...
                                     <ul class="statistics-list">
                                         <li>
                                             <div class="statistic-details"><span class="icons"><i
                                                 ...
                                                 Views </div><span class="text-end"> 453563</span>
                                         </li>
                                         <li>
                                             <div class="statistic-details"><span class="icons"><i
                                                         class="feather-star"></i></span>
                                                 Ratings </div><span class="text-end"> 153</span>
                                         </li>
                                         <li>
                                             <div class="statistic-details"><span class="icons"><i
                                                         class="feather-heart"></i></span>
                                                 Favuorites </div><span class="text-end"> 123</span>
                                         </li>
                                         <li class="mb-0">
                                             <div class="statistic-details"><span class="icons"><i
                                                         class="feather-share-2"></i></span>
                                                 Shares </div><span class="text-end"> 50</span>
                                         </li>
                                     </ul>
                                 </div>
                                 <div class="card">
